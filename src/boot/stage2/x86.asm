...
global _x86_Video_InputCharTeletype
_x86_Video_InputCharTeletype:

        push bp
        mov bp, sp

                        ; ax = return character we get from the keyboard        
        mov ah, 0x00
        int 0x16
                        ;al is our ascii no need for the top of the register
        xor ah, ah
